...
using ProyectoRubioApiClickyCrates.Models;
using ProyectoRubioApiClickyCrates.Providers;
using ProyectoRubioApiClickyCrates.Results;

namespace ProyectoRubioApiClickyCrates.Controllers
{
    [Authorize]
